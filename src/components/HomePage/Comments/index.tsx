...
import { WorkspaceWrap } from '../Workspaces/styles';
import { CommentsTitle, CommentsWrapper, SelectorContainer, StyledOption, StyledSelect } from './SingleComment/styles';
...
import { Button, EntitiesHeader, EntitiesHeaderRight, Form, Input } from '../../Pages/EntitiesPage/SingleEntity/styles';
...
const Comments: FC<ICommentsUser>=props=>{
