...
import { BigWrapper, Edit2, ProfileForm2, SmallWrapper, SmallWrapperForFields, SelectField, Title, Title2, InputField, UserImg, Row, TableTitle, TableContent, SelectField2, StyledDate} from "./styles";
...
import { HeaderItem, SeeProfile} from "../styles";
            ...
            >
                ...
                <ProfileForm2>
                    ...
                    <SmallWrapper style={{marginBottom:'7px', background:'#F5F7F9', padding:'5px 0'}}>
                        <UserImg imgUrl = {photoList? userPhoto(user1):''}/>
                    ...
                    <SmallWrapper style={{marginBottom:'10px', background:'#F5F7F9', padding:'5px 0'}}>
                        <UserImg imgUrl = {photoList? userPhoto(user2):''}/>
                        <SelectField2 as="select" name="user" disabled = {toggle}>
                            {usersList.map((user)=>(<option key={user.id} value={user.name}>{user.name}</option>))}
                        </SelectField2>
                        <HeaderItem beforeImg = {Icons.messageIcon} style={{fontSize: '20px', paddingLeft:'45px', color:'#8C91A0'}}>Message</HeaderItem>
                    ...
                    <BigWrapper>
                        ...
                        <Row>
                            ...
                            <TableContent>
                                <StyledDate selected={date1} onChange={(date:any) => setDate1(date as Date)} disabled = {toggle}></StyledDate> 
                            </TableContent>
                            <TableContent>
                        ...
                        <Row>
                            ...
                            <TableContent>
                                <StyledDate selected={date2} onChange={(date:any) => setDate2(date as Date)} disabled = {toggle}></StyledDate> 
                            </TableContent>
                            <TableContent>
                        ...
                        <Row>
                            ...
                            <TableContent>
                                <StyledDate selected={date3} onChange={(date:any) => setDate3(date as Date)} disabled = {toggle}></StyledDate> 
                            </TableContent>
                            <TableContent>
                    ...
                    <BigWrapper>
                        ...
                        <Row>
                            ...
                            <TableContent>
                                <StyledDate selected={date4} onChange={(date:any) => setDate4(date as Date)} disabled = {toggle}></StyledDate> 
                            </TableContent>
                        </Row>
                        <Row>
                            <TableContent>
                            ...
                            <TableContent>
                                <StyledDate selected={date5} onChange={(date:any) => setDate5(date as Date)} disabled = {toggle}></StyledDate> 
                            </TableContent>
                        </Row>
                        <Row>
                            <TableContent>
                            ...
                            <TableContent>
                                <StyledDate selected={date6} onChange={(date:any) => setDate6(date as Date)} disabled = {toggle}></StyledDate> 
                            </TableContent>
                        </Row>
