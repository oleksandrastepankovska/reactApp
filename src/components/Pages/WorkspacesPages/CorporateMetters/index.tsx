...
import { CorporateMattersWrapper, HeaderText } from '../styles';
import {WorkspaceItem} from './WorkspacesItem'
import { EntitiesHeader } from '../../EntitiesPage/SingleEntity/styles';
